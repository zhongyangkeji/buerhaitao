...
public class Sp_a2_XingHao extends BaseActivity{
	...
	private TextView tv_chanpinprice,tv_kucun,tiaomu1,tiaomu2,tv_qxzlx,tv_qxzlx1,tv_addcar;
...
//			"设置", "语音", "天气", "浏览器", "视频" };
	...
	private void initView(){
		...
		String tiaomu = getIntent().getStringExtra("tiaomu");
		...
		if (tiaomu.equals("1")) {
			...
			final List<ChanPinCanShu> cpcs = JSONArray.parseArray(strarry, ChanPinCanShu.class);
			sim_adapter = new ArrayAdapter<ChanPinCanShu>(this, R.layout.itemss, R.id.text, cpcs);
			//配置适配器
			...
			gview.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1,
					...
					tv_qxzlx.setText(tiaomu1.getText() + ":"+ cpcs.get(position).getName());
					Toast.makeText(getApplicationContext(), cpcs.get(position).getId(), Toast.LENGTH_LONG).show();
				}
			}); 
		...
		if (tiaomu.equals("2")) {
			...
			final List<ChanPinCanShu> cpcs1 = JSONArray.parseArray(strarry1, ChanPinCanShu.class);
			sim_adapter = new ArrayAdapter<ChanPinCanShu>(this, R.layout.itemss, R.id.text, cpcs1);
			//配置适配器
			...
			gview1.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1,
						int position, long arg3) {
					// TODO Auto-generated method stub
					tv_qxzlx1.setText(tiaomu2.getText() + ":"+ cpcs1.get(position).getName());
					Toast.makeText(getApplicationContext(), cpcs1.get(position).getId(), Toast.LENGTH_LONG).show();
				}
			});
	...
	public void onClick(View v) {
		...
		case R.id.im_sp_a1_back3:
			...
			break;
		case R.id.tv_addcar:
			Intent itaddcar = new Intent();
			itaddcar.setClass(Sp_a2_XingHao.this, B3_ShoppingCartActivity.class);
			startActivity(itaddcar);
			break;
